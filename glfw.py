...
def glfwGetWindowParam(window, param):
	'''
	This function returns a property of the specified window. There are many different properties, some related to the window and others to its context.
	...
	return libglfw.glfwGetWindowParam(window._handle, param)
