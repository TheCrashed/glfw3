...
windowclosefun = ctypes.CFUNCTYPE(None, ctypes.POINTER(window))
...
charfun = ctypes.CFUNCTYPE(None, ctypes.POINTER(window), ctypes.c_uint)
...
GetMonitorPos = glfwDLL.glfwGetMonitorPos
GetMonitorPos.argtypes = [ctypes.POINTER(monitor), ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int)]
GetMonitorPos.restype = None

GetMonitorPhysicalSize = glfwDLL.glfwGetMonitorPhysicalSize
GetMonitorPhysicalSize.argtypes = [ctypes.POINTER(monitor), ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int)]
GetMonitorPhysicalSize.restype = None
...
SetGamma.argtypes = [ctypes.POINTER(monitor), ctypes.c_float]
SetGamma.restype = None

GetGammaRamp = glfwDLL.glfwGetGammaRamp
GetGammaRamp.argtypes = [ctypes.POINTER(monitor), ctypes.POINTER(gammaramp)]
GetGammaRamp.restype = None

SetGammaRamp = glfwDLL.glfwSetGammaRamp
SetGammaRamp.argtypes = [ctypes.POINTER(monitor), ctypes.POINTER(gammaramp)]
...
WindowShouldClose = glfwDLL.glfwWindowShouldClose
WindowShouldClose.argtypes = [ctypes.POINTER(window)]
WindowShouldClose.restype = ctypes.c_int

SetWindowShouldClose = glfwDLL.glfwSetWindowShouldClose
SetWindowShouldClose.argtypes = [ctypes.POINTER(window), ctypes.c_int]
SetWindowShouldClose.restype = None
...
GetWindowPos.argtypes = [ctypes.POINTER(window), ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int)]
GetWindowPos.restype = None

SetWindowPos = glfwDLL.glfwSetWindowPos
SetWindowPos.argtypes = [ctypes.POINTER(window), ctypes.c_int, ctypes.c_int]
