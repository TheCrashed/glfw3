...
GLFWmousebuttonfun = ctypes.CFUNCTYPE(None, ctypes.POINTER(GLFWwindow), ctypes.c_int, ctypes.c_int)

GLFWcursorposfun = ctypes.CFUNCTYPE(None, ctypes.POINTER(GLFWwindow), ctypes.c_int, ctypes.c_int)
...
GLFWkeyfun = ctypes.CFUNCTYPE(None, ctypes.POINTER(GLFWwindow), ctypes.c_int, ctypes.c_int)
...
glfwSetErrorCallback.restype = None
...
glfwSetMonitorCallback.restype = None
...
glfwGetVideoMode.restype = GLFWvidmode
...
glfwGetGammaRamp.argtypes = (ctypes.POINTER(GLFWmonitor), ctypes.POINTER(GLFWgammaramp))
glfwGetGammaRamp.restype = None
...
glfwGetWindowParam = glfwLib.glfwGetWindowParam
glfwGetWindowParam.argtypes = (ctypes.POINTER(GLFWwindow), ctypes.c_int)
glfwGetWindowParam.restype = ctypes.c_int
...
glfwSetWindowPosCallback.restype = None
...
glfwSetWindowSizeCallback.restype = None
...
glfwSetWindowCloseCallback.restype = None
...
glfwSetWindowRefreshCallback.restype = None
...
glfwSetWindowFocusCallback.restype = None
...
glfwSetWindowIconifyCallback.restype = None
...
glfwGetCursorPos.argtypes = (ctypes.POINTER(GLFWwindow), ctypes.POINTER(ctypes.c_int), ctypes.POINTER(ctypes.c_int))
glfwGetCursorPos.restype = None

glfwSetCursorPos = glfwLib.glfwSetCursorPos
glfwSetCursorPos.argtypes = (ctypes.POINTER(GLFWwindow), ctypes.c_int, ctypes.c_int)
...
glfwSetMouseButtonCallback.restype = None
...
glfwSetCursorPosCallback.restype = None
...
glfwSetCursorEnterCallback.restype = None
...
glfwSetScrollCallback.restype = None

glfwGetJoystickParam = glfwLib.glfwGetJoystickParam
glfwGetJoystickParam.argtypes = (ctypes.c_int, ctypes.c_int)
glfwGetJoystickParam.restype = ctypes.c_int

glfwGetJoystickAxes = glfwLib.glfwGetJoystickAxes
glfwGetJoystickAxes.argtypes = (ctypes.c_int, ctypes.POINTER(ctypes.c_float), ctypes.c_int)
glfwGetJoystickAxes.restype = ctypes.c_int

glfwGetJoystickButtons = glfwLib.glfwGetJoystickButtons
glfwGetJoystickButtons.argtypes = (ctypes.c_int, ctypes.POINTER(ctypes.c_ubyte), ctypes.c_int)
glfwGetJoystickButtons.restype = ctypes.c_int
